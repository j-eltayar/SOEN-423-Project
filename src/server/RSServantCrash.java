...
public class RSServantCrash extends RSPOA{
	...
	public RSServantCrash(String name) throws IOException {
		...
		if(roomNumber == -1) {
	        ...
	        // String to proper list
	 		...
	 		for(int i = 0; i<stringArrays.length; i++) {
	 			String[] temp = new String[]{stringArrays[9999].split(",")[0], stringArrays[i].split(",")[1], stringArrays[i].split(",")[2]};
